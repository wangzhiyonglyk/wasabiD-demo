...
let src="app.png"
class DateView extends React.Component<iDateView> {
    constructor(props) {
        super(props);
        this.state = {
...
// this.refs.modal.open();
    ...
    render() {
        return <div>
            <img style={{width:"100px",height:100}} src={require("./"+src)}></img>
...
ReactDOM.render(<DateView />, document.getElementById('root'));
