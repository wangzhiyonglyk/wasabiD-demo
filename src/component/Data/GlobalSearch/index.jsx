...
class GlobalSearch extends React.Component {
  ...
  render() {
    return (
      <div
        className="wasabi-globalsearch"
        style={{ transform: this.state.visible ? "scale(1)" : "scale(0)" }}
      >
        <div
          id={this.state.overid}
          className="wasabi-globalsearch-overlay"
          onClick={this.close}
        ></div>
        <div
          id={this.state.searchid}
          className={
            "wasabi-globalsearch-container" +
