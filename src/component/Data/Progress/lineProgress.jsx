...
class LineProgress extends React.Component {
  ...
  render() {
    return (
      <div
        className={
          "wasabi-progress wasabi-progress-line " + this.props.className
        }
      ...
      >
        <div className="wasabi-progress-bar">
          <div className="wasabi-progress-bar-outer">
            <div
              className={"wasabi-progress-bar-inner " + this.props.theme}
              style={{ width: this.state.value + "%" }}
            ></div>
          </div>
        </div>
        <div className={"wasabi-progress-text " + this.props.theme}>
          {this.props.text ? this.props.text : this.state.value + "%"}
        </div>
      </div>
    );
  }
