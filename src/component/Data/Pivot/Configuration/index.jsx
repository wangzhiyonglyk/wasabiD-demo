...
class Configuration extends Component {
  ...
  static getDerivedStateFromProps(props, state) {
    ...
    for (let key in props) {
      if (
        state.hasOwnProperty(["old" + key]) &&
        func.diff(state["old" + key], props[key])
      ) {
        //更新此字段
    ...
    return (
      ...
      >
        ...
        <div style={{ float: "right" }}>
          <Button key="cancel" theme="default" onClick={this.close}>
            取消
          </Button>
          <Button key="success" theme="success" onClick={this.applyHandler}>
            提交
          </Button>
        </div>
      </div>
  ...
  render() {
    return (
      <div>
        <div
          className="wasabi-pivot-configuration"
          onClick={this.props.applyHandler ? this.open.bind(this) : () => {}}
          style={{
        ...
        <Modal
          ref={this.modal}
          style={{ width: 1000, height: 600, top: 10, left: 10 }}
          title={this.renderTool()}
        >
          {
