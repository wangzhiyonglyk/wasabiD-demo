            ...
            >
              ...
              >
                <Input
                  ...
                  onSelect={this.rowEditHandler.bind(this, columnIndex)}
                  label={''}
                ></Input>
              </div>
            </td>
        ...
        headerMenuCotrol.push(
          <li key={index}>
            <a
              ...
              onMouseDown={this.menuShowHandler.bind(this, index, item)}
            >
              {'显示[' + item + ']'}
            </a>
          </li>
...
mixins(DataGrid, [ClickAway, DataGridHandler, DataGridExtend, pasteExtend]);
