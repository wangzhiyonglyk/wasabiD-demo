...

                    {
                      React.  Children.map(this.props.children, (child, index) => {
                            ...
                            if (typeof child.type !== "function") {//非react组件
                                ...
                                return React. cloneElement(child, { disabled:this.props.disabled?this.props.disabled:child.disabled,   readonly: this.props.disabled?this.props.disabled:child.props.readonly, key: index, ref: child.ref?child.ref:index })
                            }
