...
class Dropdown extends Component {
  ...
  render() {
    ...
    return (
      <div ref={this.wasabidropdown} {...props} id={this.state.containerid}>
        <LinkButton
        ...
        <i
          className={
            "wasabi-dropdown-arrow  " +
            (this.props.menuIconCls ?? "") +
            (this.props.iconCls ? "" : "noicon")
          }
          onClick={this.showMenu}
        ></i>
        <ul
          className={"wasabi-dropdown-menu "}
          style={{ display: this.state.menuShow ? "block" : "none" }}
        >
