 ...
 */
let ripple = function (element, callBack) {
  element &&
    element.addEventListener("click", (event) => {
      ...
      setTimeout(() => {
        ...
        //   rippleContainer.style.zIndex = element.style.zIndex
        ...
        ripple.style.left =
          event.pageX - elementPosition.left - circleD / 2 + "px";
        ripple.style.top =
          event.pageY - elementPosition.top - circleD / 2 + "px";
