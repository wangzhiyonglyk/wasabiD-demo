...
class Button extends React.Component {
  ...
  onDoubleClick(event) {
    ...
    this.props.onDoubleClick &&
      this.props.onDoubleClick(this.props.name, this.props.title, event);
  }
  setDelay() {
    this.setState({
      isdelay: true,
  ...
  render() {
    let props = {
      ...
      disabled:
        this.props.disabled === true || this.state.isdelay === true
          ? "disabled"
          : null,
      //文字提示
      title: this.props.title,
    };
    return this.props.children || this.props.iconCls ? (
      <button
        {...props}
        id={this.buttonid}
