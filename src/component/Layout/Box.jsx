    ...
    return (
      ...
      >
        <div className="box-title">
          <span className={"label label-" + this.props.theme}>
        ...
        <div className="box-content">
          ...
          <div className={"text text-" + this.props.theme}>
            {this.props.bottomRightTitle}
          </div>
...
Box.propTypes = {
  ...
  theme: PropTypes.oneOf(["primary", "success", "info", "danger"]), //主题
