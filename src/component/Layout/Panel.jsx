...
class Panel extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        className={
          "wasabi-panel panel-" + this.props.theme + " " + this.props.className
        }
        style={style}
      >
        <div className="panel-header" style={this.props.headerStyle}>
          ...
          <div
            ...
            style={{ display: this.props.expandAble ? "block" : "none" }}
          >
            <i
              title={this.state.iconTip}
              className={this.state.iconCls}
            ...
            <i
              ...
              style={{
                marginLeft: 10,
                display: this.props.closeAble ? "inline" : "none",
              }}
              title="关闭"
        ...
        <div
          ...
          style={{ overflow: style.height == 0 ? "hidden" : null }}
        >
          {this.props.children}
        </div>
      </div>
