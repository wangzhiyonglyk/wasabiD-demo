    ...
    render() {
        return (
            <div className={"wasabi-tabs " + (this.props.className || "")} style={this.props.style} >
                    <div className={"wasabi-tab-nav "}  >
                        <div key="pre" title="上一个" onClick={this.preClick.bind(this)} className={"wasabi-tab "} style={{ float: "left", textAlign: "center", width: 40 }}> <LinkButton theme="info" style={{ transform: "translateY(-3px)" }} iconCls="icon-angle-double-left"></LinkButton></div>
                        <div id={this.state.navid} style={{ width: "calc(100% - 120px)", float: "left", height: "100%", overflow: "hidden", display: "flex", flexDirection: "row", flexWrap: "nowrap" }}>
                            {
                        ...
                        <div key="next" onClick={this.nextClick.bind(this)} title="下一个" className={"wasabi-tab "} style={{ float: "left", textAlign: "center", width: 40 }}>  <LinkButton style={{ transform: "translateY(-3px)" }} theme="info" iconCls="icon-angle-double-right"></LinkButton></div>
