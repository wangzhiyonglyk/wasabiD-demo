...
class Article extends React.Component {
  ...
  render() {
    return (
      <Layout className="wasabi-article">
        <Left width={300} className="wasabi-article-catalog">
          <div className="tool">
            <LinkButton
              iconCls="icon-txt"
              onClick={this.add.bind(this, "txt")}
              style={{ fontSize: 28, marginLeft: 30 }}
              theme="info"
              title="正文"
            ></LinkButton>
            <LinkButton
              iconCls="icon-file"
              onClick={this.add.bind(this, "title")}
              style={{ fontSize: 28, marginLeft: 30 }}
              theme="info"
              title="子标题"
            ></LinkButton>
            <LinkButton
              ...
              style={{ fontSize: 34, marginLeft: 30 }}
              theme="info"
              title="图片"
            ></LinkButton>
          </div>
          <ul className="list">
            {this.state.tempContent &&
              this.state.tempContent.map((item, index) => {
                return (
                  <li
                    key={index}
                    className={this.state.activeIndex == index ? "active" : ""}
                    onClick={this.editSection.bind(this, index)}
                  >
                    {/* {
                    ...
                    {
                      <span className="wasabi-article-ellipsis">
                        {item.type == "image" ? (
                          <img
          ...
          <Simulator style={{ marginLeft: 0 }}>
            <div className={"wasabi-article-center"}>
              <div
                ...
                className="wasabi-article-title"
              ...
              >
                <img
                  className="wasabi-article-headericon"
                  src={this.props.headerIcon}
                ></img>
                <div style={{ marginLeft: 10, textAlign: "left" }}>
                  <div>
                    <span className="wasabi-article-author">
                      {this.props.author ? this.props.author : "匿名"}
                    </span>
                  </div>
                  <div>
                      ...
                      case "title":
                        control = (
                          <div
                            ...
                            onBlur={this.contentTxtChange.bind(this, index)}
                          ></div>
                        );
                        break;
                      case "txt":
