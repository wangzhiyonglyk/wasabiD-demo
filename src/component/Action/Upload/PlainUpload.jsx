    ...
    if (this.state.files && this.state.files.length > 0) {
      if (this.props.uploadurl) {
        ...
        if (this.state.files.length == 1) {
          ...
          if (
            this.props.size &&
            this.props.size * 1024 * 1024 < this.state.files[0].size
          ) {
          ...
          formData.append(
            this.props.name || this.state.files[0].name,
            this.state.files[0]
          );
        } else {
          let size = 0; //文件总大小
  ...
  imgLoad(id, event) {
    try {
      ...
      if (path instanceof Array && path.length > 0) {
        ...
        let height =
          path[0].naturalHeight && path[0].naturalHeight < parentHeight
            ? path[0].naturalHeight
            : parentHeight;
  ...
  render() {
    ...
    return (
      ...
      >
        <div
          key="1"
          className={"wasabi-upload " + (this.props.disabled ? "disabled" : "")}
        ...
        >
          ...
          >
            ...
            <div className="wasabi-upload-text">
              将{this.props.type == "file" ? "文件" : "图片"}拖到此处，或
              <LinkButton onClick={this.onClick.bind(this)}>
                点击上传
              </LinkButton>
            </div>
            <input
          ...
          <div
            key="preview"
            onClick={this.onClick.bind(this)}
            className="wasabi-uplaod-files preview"
            style={{
              display:
                this.state.files &&
                this.state.files.length == 0 &&
            ...
            this.state.files.map((item, index) => {
              return (
                ...
                >
                  ...
                  <LinkButton iconCls={"icon-" + iconCls} theme={theme}>
