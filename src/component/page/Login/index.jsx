...
class Login extends React.Component {
    ...
    if (this.props.url || this.props.loginHandler) {
      if (this.state.username && this.state.password) {
        if (
          ...
          typeof this.props.loginHandler === "function"
        ) {
  ...
  render() {
    return (
      <div
        className="wasabi-login"
        style={{
          backgroundImage:
            typeof this.props.backgroundImage === "string"
              ? "url(" + this.props.backgroundImage + ")"
              : this.props.backgroundImage
              ? require(this.props.backgroundImage)
              : null,
        }}
      >
